...
const watch = async (req, res, next) => {
    ...
    res.render('bill/test', { customer: mongooseToObject(customer), customer1: mongooseToObject(customer1), bill: mongooseToObject(bill), service: multipleMongooseToObject(service) })
