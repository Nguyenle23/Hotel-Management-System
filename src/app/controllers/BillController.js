...
const watch = async (req, res, next) => {
    ...
    res.render('bill/xemHoaDonKoScript', { customer: mongooseToObject(customer), customer1: mongooseToObject(customer1), bill: mongooseToObject(bill), service: multipleMongooseToObject(service) })
